...
<body>
	...
	<div>
		<div class="row">
			<div class="col-xs-12">
				<img class="hero" alt="" src="img/hero.jpg" />              
			</div>
		</div>
	</div>
	...
	<div class="quote col-xs-12">
			<div class="col-xs-3 col-sm-2">
				<div class="image"><img alt="" src="img/arthur.png" width="80" /><p>Arthur</p></div>
			</div>
			<div class="col-xs-9 cold-sm-10">
				<h3>Arthur was our first customer, thanks Arthur!</h3>
				<p>"I had a domain registered for many years, but I wasn't doing anything with it. Jordan built my site for me in two days, updated all of the content to my specifications, and has been very responsive about updating it. I'm so happy with Cursive." <br/>&#8212;Arthur Manzi of <a href="http://resonantwords.com">resonantwords.com</a></p>
			</div>		
	</div>
...
<div class="container col-xs-12" id="plans">
	...
	<div class="col-xs-12">
		<div class="col-xs-6">
			<div class="image"><img class="founders" alt="" src="img/jordan.png" /><p>Jordan</p></div>
		</div>
		<div class="col-xs-6">
			<div class="image"><img class="founders" alt="" src="img/zach.png" /><p>Zach</p></div>
		</div>
	</div>
	...
	<hr>
		<div class="col-xs-3 col-sm-2">
			<div class="image"><img class="icons" src="img/alexander.png" alt="" /><p>Alexander</p></div>
		</div>
		<div class="col-xs-9 col-sm-10">
...
<footer id="footer">
	<div class="container">
		<div class="logo"></div>
		<p>&copy; 2014 Rocketship Labs, LLC.</p>
		<div class="social pull-right hidden-xs">    
			<!-- Twitter -->
			<a href="https://twitter.com/getcursive" class="twitter-follow-button" data-show-count="false" data-lang="en">Follow @getcursive</a>
			<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
    
			<!-- Facebook -->
			<div class="fb-like" data-href="https://www.facebook.com/getcursive" data-layout="button_count" data-action="like" data-show-faces="false" data-share="true"></div>
